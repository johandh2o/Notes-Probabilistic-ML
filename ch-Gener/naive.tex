...
Thus, the predictive posterior probability depends on the expected value of the posterior probabilities. In this case, the posterior distribution are tractable because the prior distributions are \red{conjugate}.
